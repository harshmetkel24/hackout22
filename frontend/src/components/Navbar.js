      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="d-flex">
            ...
            {token && <>
              <ul className="navbar-nav me-auto mb-2 mb-lg-0" style={{ paddingRight: "8px", marginTop: "5px" }} >
                <li className="nav-item">
                  Welcome {userName}
              ...
              <Link to="/login">
                <button className="btn me-3 btn-outline-dark" onClick={handleSubmit}>Log out</button>
              </Link>
            </>
            }
          </div>
